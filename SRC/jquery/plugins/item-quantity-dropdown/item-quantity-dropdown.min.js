    ...
    this.each(function () {
      ...
      function updateDisplay() {
        ...
        $items.each(function (index) {
          var itemCount = $(this).find('.counter').text();
          var itemName = $(this).find('.iqdropdown-item').text();            
          if (itemCount>0)
          total += (itemCount + ' ' + itemName + ', ');
        })
        $selection.html(total.slice(0,total.lastIndexOf(', ')));
      }
...
/*
          ...
          console.log(total.slice(0,total.lastIndexOf(', ')));
*/
          event.preventDefault();
      ...
      $items.each(function () {
        const $item = $(this);
        //console.log($item.find('.iqdropdown-item').text());
